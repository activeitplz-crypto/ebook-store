...
3. `NEXT_PUBLIC_ADMIN_EMAIL`: Set to `itxprince440@gmail.com` to enable the admin panel for this email.
4. `NEXT_PUBLIC_BASE_URL`: Your deployed site URL (e.g., `https://your-site.netlify.app`). This is used for email redirects and links.
